...
class PushNotificationsScreen extends StatefulWidget {
  ...
  @override
  PushNotificationsScreenState createState() =>
      PushNotificationsScreenState();
}
...
class PushNotificationsScreenState extends State<PushNotificationsScreen> {
  ...
  Future<void> _onScheduleNotificationButtonPressed() async {
    ...
    await flutterLocalNotificationsPlugin.schedule(
      ...
      payload: 'scheduled_notification', // Дополнительные данные, передаваемые с уведомлением
    );
    ...
    showDialog(
      ...
      builder: (context) {
        return AlertDialog(
          ...
          content: const Text('Уведомление будет отправлено в выбранное время.'),
          actions: [
            TextButton(
              child: const Text('ОК'),
              onPressed: () {
